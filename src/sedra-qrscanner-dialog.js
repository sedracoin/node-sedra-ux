...
class SedraQRScannerDialog extends SedraDialog{
	...
	static get styles(){
		return [SedraDialog.styles, css`
			.container{
				...
				max-height:var(--sedra-dialog-container-max-height, 620px);
			}
...
SedraQRScannerDialog.define("sedra-qrscanner-dialog");
