import {html, css, FlowFormat, i18n, T} from './sedra-wallet-ui.js';
import {SedraWalletMobile} from './sedra-wallet-mobile.js';

export class SedraWalletDesktop extends SedraWalletMobile{
	...
	static get styles(){
		return [SedraWalletMobile.styles, css`
			:host{overflow:hidden}
			.container{
				padding:var(--sedra-wallet-container-padding, 15px);
			...
			.wallet-warning{
				...
				background-color:var(--sedra-wallet-warning-bg, #fdf8e4);
			}
			...
			.right-area{
				...
				height:var(--sedra-wallet-right-area-height, calc(100vh - 122px));
			...
			.top-menu{
				...
				position:var(--sedra-wallet-top-menu-position, absolute);
				right:var(--sedra-wallet-top-menu-right, 20px);
				top:var(--sedra-wallet-top-menu-top, -4px);
				z-index:2;
			...
			.header{
				border-bottom:var(--sedra-wallet-header-border-bottom, --2px solid var(--sedra-wallet-tab-border-top-color, var(--flow-primary-color)));
			}
		`];
	}
	constructor() {
