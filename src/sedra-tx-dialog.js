import {
	html, css, SedraDialog, SDR, txListStyle,
	paginationStyle, buildPagination,
	renderPagination, T
} from './sedra-dialog.js';

class SedraTXDialog extends SedraDialog{
	...
	static get styles(){
		return [SedraDialog.styles, paginationStyle, txListStyle,
		css`
			:host{
				position:fixed;
			...
			.container{
				max-height:var(--sedra-dialog-container-max-height, 90%);
				max-width:var(--sedra-dialog-container-max-width, 90%)
			}
...
SedraTXDialog.define("sedra-tx-dialog");
