import {
	html, css, SedraDialog, chunks, getRandomInt, shuffle,
	T, i18n
} from './sedra-dialog.js';

class SedraSeedsDialog extends SedraDialog{
	...
	static get styles(){
		return [SedraDialog.styles, css`
			...
			.container{max-height:var(--sedra-dialog-container-max-height, 660px)}
...
SedraSeedsDialog.define("sedra-seeds-dialog");
